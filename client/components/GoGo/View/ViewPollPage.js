...
export default class ViewPollPage extends React.Component {
    constructor(props) {
        ...
        store.eventDispatcher.register((event) => {
            this.setState({event: event});
        });

        store.loadEvent(this.eventId);
    }
        ...
        return <div className={[styles.component, coreStyles.core].join(' ')}>
            <div className={coreStyles.body}>
                <div>
                    ...
                    <PollTableView pollOptions={poll.pollOptions} pollParticipants={poll.pollParticipants}/>
